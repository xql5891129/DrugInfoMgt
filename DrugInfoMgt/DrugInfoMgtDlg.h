...
// CDrugInfoMgtDlg 对话框
class CDrugInfoMgtDlg : public CDialogEx
{
// 构造
public:
	CDrugInfoMgtDlg(CWnd* pParent = nullptr);	// 标准构造函数

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DRUGINFOMGT_DIALOG };
#endif
...
public:
	...
	{// 创建connection对象
		try {
			...
			// 设置字符串
			_bstr_t strConnect = "Provider=SQLNCLI11.1;Persist Security Info=False;User ID=sa;Initial Catalog=xql;Data Source=DESKTOP-1VPFSGK;Initial File Name="";Server SPN=""";// Catalog数据库名称，Data数据库 .表示本地数据库
